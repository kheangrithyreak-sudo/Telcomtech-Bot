...
SHOP_URL = "https://kheangrithyreak-sudo.github.io/telcomtech-store/"
...
def shop_keyboard() -> ReplyKeyboardMarkup:
    ...
    return ReplyKeyboardMarkup(
        [[KeyboardButton("🛖 Open Shop", web_app=WebAppInfo(url="https://kheangrithyreak-sudo.github.io/TelcomTech_store/"))]],
